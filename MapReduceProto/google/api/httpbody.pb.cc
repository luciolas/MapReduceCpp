...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_google_2fapi_2fhttpbody_2eproto = {
  false, false, descriptor_table_protodef_google_2fapi_2fhttpbody_2eproto, "google/api/httpbody.proto", 270,
...
static bool dynamic_init_dummy_google_2fapi_2fhttpbody_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_google_2fapi_2fhttpbody_2eproto)), true);
namespace google {
namespace api {
